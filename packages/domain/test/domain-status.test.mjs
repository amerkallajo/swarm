...
const LEGAL_RULES = [
  ...
  ["APPROVED_FOR_OUTREACH", "RECORD_OUTREACH_SENT", "CONTACTED", ["SYSTEM"]],
  ...
  ["PREVIEW_REVIEW", "RECORD_PREVIEW_SENT", "PREVIEW_SENT", ["SYSTEM"]],
...
test("exposes immutable unique rules without mutable internals and returns mutation-proof pure results", () => {
  ...
  assert.equal(domain.LEAD_TRANSITIONS.length, 46);
